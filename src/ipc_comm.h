...
const char      SHM_NAME[] = "/IPC_TEST_FIRST";

// data will be stored at share memory position: SHM + SHM_DATA
typedef struct {
    uint64_t lock_flag;
    uint64_t data_size;
} SHM_HEADER;

typedef std::atomic<SHM_HEADER> ATOM_SHM_HEADER;
